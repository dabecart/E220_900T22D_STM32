...
inline uint8_t CircularBuffer::push(uint8_t ucItem) {
...
inline uint8_t CircularBuffer::pushN(uint8_t* items, uint32_t count) {
...
inline uint8_t CircularBuffer::pop(uint8_t* item) {
    if(len < 1) return 0;
...
inline uint8_t CircularBuffer::popN(uint32_t count, uint8_t* items) {
...
inline uint8_t CircularBuffer::peek(uint8_t* item) {
    if(len < 1) return 0;
...
inline uint8_t CircularBuffer::peekN(uint32_t count, uint8_t* items) {
    if(items == NULL) return 0;
    if(count == 0) return 1;
